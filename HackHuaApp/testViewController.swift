...
class testViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myMotionManager.startAccelerometerUpdatesToQueue(NSOperationQueue.mainQueue(), withHandler: {(accelerometerData:CMAccelerometerData!, error:NSError!) -> Void in
            ...
            //            if  accelerometerData.acceleration.x < -0.15
            //            {
            ...
            //            }
            //
            //            else if accelerometerData.acceleration.y < -0.15
            //            {
            ...
            //
            //            }
            //            else if accelerometerData.acceleration.x > 0.15
            //            {
            //                self.playeruaM04.currentTime = 0
            //                self.playeruaM04.play()
            //                let iv:UIImageView = UIImageView(image:imgM02)
            ...
            if  accelerometerData.acceleration.x > 0.02
            {
                self.playeruaM02.currentTime = 0
                self.playeruaM02.play()
            ...
            else if  accelerometerData.acceleration.y > 0.02
            {
                self.playeruaM02.currentTime = 0
                self.playeruaM02.play()
            ...
            else if  accelerometerData.acceleration.z > 0.02
            {
                self.playeruaM02.currentTime = 0
                self.playeruaM02.play()
                ...
                //            if  accelerometerData.acceleration.x > 0.15 || accelerometerData.acceleration.y > 0.15
                //            {
                //                self.playeruaM02.currentTime = 0
                //                self.playeruaM02.play()
                //
                ...
                //
                //            }
                //            else if  accelerometerData.acceleration.z > 0.1
                //            {
                //                self.playerrakka.currentTime = 0
                //                self.playerrakka.play()
                //                let iv:UIImageView = UIImageView(image:imgM02)
                //                iv.frame = CGRectMake(35,100, 250, 350)
                //                self.view.addSubview(iv)
                //
